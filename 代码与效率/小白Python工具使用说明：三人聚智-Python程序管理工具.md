...
bili 视频3：[小白Python工具使用说明2：三人聚智-Python程序管理工具_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1TwVR6qEZt/?vd_source=247ac77d4ae7339ea06d0fec09aa8f70)
...
![小白Python工具使用说明：三人聚智-Python程序管理工具](附件/AI图片/小白Python工具使用说明：Python 程序管理工具-16x9.png)
